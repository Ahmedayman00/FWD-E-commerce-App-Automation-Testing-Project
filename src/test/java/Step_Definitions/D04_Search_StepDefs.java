...
public class D04_Search_StepDefs {
    ...
    public void user_could_find_relative_results()
    {
        ...
        for (int x = 0; x < count ; x++) {
            ...
            Assert.assertTrue(searchPage.searchResults().get(0).getText().contains("MacBook"));
        }
    }

    //Scenario: user could search for product using Tshirt

    @And("user search with Tshirt of product")
    public void search_with_Tshirt_of_product() throws InterruptedException {
